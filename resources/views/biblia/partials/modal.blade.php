...
<!-- MODAL : Ventana con los comentarios -->
<div class="modal fade" id="listComentariosModal" tabindex="-1" role="dialog" aria-labelledby="listComentariosModalLabel">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="listComentariosModalLabel">Comentarios</h4>
            </div>
            <div class="modal-body capa-scroll">
