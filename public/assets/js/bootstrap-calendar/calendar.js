			...
			case 'string':
				if(source.length) {
					loader = function() {
						...
						* CODIGO PROPIO ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
						*/
						if(self.options.swt_plan == true){
							params = {plan_slug: self.options.plan_slug,from: self.options.position.start.getTime(), to: self.options.position.end.getTime()};
						}

						/**
						* FIN DE CODIGO PROPIO ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
						*/
